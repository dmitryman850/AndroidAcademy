...
class FilmsData {
    fun getFilmsData(): List<Film> {
        return listOf(
            Film(
                1, R.drawable.first_movie_list, "16+", "AVENGERS: END GAME",
                "Action, Shooter", "12500 REVIEWS", "It's a good film",
                R.drawable.robert, "Robert"
            ),
            Film(
                2, R.drawable.first_movie_list, "18+", "Snatch",
            ...
            Film(
                3, R.drawable.first_movie_list, "12+", "Lock, Stock and Two Smoking Barrels",
